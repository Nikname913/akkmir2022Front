...
const CardInfo = (props) => {
  ...
  useEffect(() => {
    ...
    if ( descr !== '' ) {
      ...
      let content = descrHTML.body.innerHTML

      // ------------------------------
      // для показа демонстрации, без данных аккмира
      // ------------------------------

      content = 'Аккумуляторы SIBBEAR. Аккумуляторные батареи SIBBEAR изготавливаются с высокой степенью надёжности и высокими электрическими характеристиками по току и напряжению. Высокое качество и электрические характеристики аккумуляторных батарей SIBBEAR достигаются за счёт применения в производстве современной кальциевой технологии и новейшего комплекса полного производственного цикла. Преимущества аккумуляторов SIBBEAR: Высокие пусковые характеристики обеспечивают стартерный режим пуска двигателя при низких зимних температурах. Применение серебра при изготовлении положительных электродов позволяет максимально повысить стойкость к коррозии при повышенных температурах в летний период. Отличные ёмкостные характеристики аккумуляторных батарей SIBBEAR обеспечиваются применением высокоактивных свинцовых порошков с высокой абсорбцией к серной кислоте. Быстрый заряд аккумулятора, то есть восстановление заряда после разряда, достигается за счёт высоких токов приёма заряда.'
